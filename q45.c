//Program in C to Demonstrate the use of string library functions: strlen(), strcpy(), strrev(), strcat(), strcmp() etc. using
//examples.
...
{
    char string1 [10] = "Cat";
    char string2 [10] = "Monkey";
    int x;

    printf("String 1 = Cat\n");
    printf("String 1 = Monkey\n");
